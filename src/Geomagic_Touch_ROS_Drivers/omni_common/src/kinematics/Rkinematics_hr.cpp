#include "Rkinematics_hr.h"

Rkinematics_ur::Rkinematics_ur()
{
        B_z_S1 = 0.095;
        S2_y_S1 = 0.135;
        S2_y_E = 0.11;
...
void Rkinematics_ur::kinematics(Eigen::Matrix4d &B_T_T, double q1, 
...
void Rkinematics_ur::geometry_jacobian(Eigen::Matrix<double,6,6> &J,  double q1, 
                                double q2,double q3, double q4, double q5, double q6)
{
    Eigen::Matrix4d W_T_B;
    W_T_B <<
...
void Rkinematics_ur::rotationVector(Eigen::Vector3d &rotationvector, Eigen::Matrix3d rot)
{
...
void Rkinematics_ur::inverse_kinematics(double &q1, double &q2,double &q3, double &q4, double &q5, 
...
void Rkinematics_ur::Error(Eigen::VectorXd &error, Eigen::Matrix4d targetMatrix, Eigen::Matrix4d nowMatrix)
{
...
void Rkinematics_ur::CaltargetMatrix(Eigen::Matrix4d &targetMatrix, double x, double y, double z,
